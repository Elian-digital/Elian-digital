...
| :--- | :--- |
| <img src="https://github.com/Elian-digital/Spain-Wildfires-Greenpeace-Analytics/blob/main/assets/cover_project.png?raw=true" width="400" /> | **Spain Wildfires: Greenpeace Strategic Analytics** <br><br> Análisis avanzado de incendios forestales en España para la optimización de recursos de prevención. <br><br> ✅ **Arquitectura de Datos Masiva** <br> ✅ **Análisis de Correlación Multivariable** <br> ✅ **Propuesta Estratégica** para Greenpeace España <br><br> [**Ver Repositorio**](https://github.com/Elian-digital/Spain-Wildfires-Greenpeace-Analytics) |

### 📊 Business Intelligence & Strategy

| Proyecto | Descripción |
| :--- | :--- |
| <img src="https://github.com/Elian-digital/PowerBI_Sales-Diagnosis-Churn-Analysis/blob/main/assets/Dashboard_1.png?raw=true" width="400" /> | **Sales Diagnosis: Identifying Revenue Leakage** <br><br> Diagnóstico de caída de ventas mediante análisis de Churn masivo en mercados europeos. <br><br> ✅ **Análisis de Causa Raíz** (Alemania) <br> ✅ **Detección del "Efecto Espejismo"** en Ticket Medio <br> ✅ **ETL Avanzado** con Power Query <br><br> [**Ver Repositorio**](https://github.com/Elian-digital/PowerBI_Sales-Diagnosis-Churn-Analysis) |
| <img src="https://github.com/Elian-digital/Customer-Intelligence-Radar-Segmentation-Strategy/blob/main/assets/Dashboard%20clientes.png?raw=true" width="400" /> | **Customer Intelligence Radar: Segmentación & ROI** <br><br> Radar interactivo para la priorización de mercados y reactivación de clientes inactivos. <br><br> ✅ **Segmentación RFM & ARPU** <br> ✅ **Motor de Recomendación Segmentada** (DAX) <br> ✅ **Matriz de Priorización Geográfica** <br><br> [**Ver Repositorio**](https://github.com/Elian-digital/Customer-Intelligence-Radar-Segmentation-Strategy) |
